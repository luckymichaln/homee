...
const getters = {
  ...
  rentalPageData: state => state.pageData.rental_management ? state.pageData.rental_management : null,
  homestagingPageData: state => state.pageData.homestaging ? state.pageData.homestaging : null,
}
